...
public class TargetMover : MonoBehaviour {
	...
	public enum motionDirections {Spin,Horizontal, Vertical,Zaxis};
	...
	void Update () {
		...
		switch(motionState) {
			...
			case motionDirections.Vertical:
				...
				break;
		case motionDirections.Zaxis:
			gameObject.transform.Translate (Vector3.back * Mathf.Cos (Time.timeSinceLevelLoad) * motionMagnitude);
			break;
		}
	}
}
